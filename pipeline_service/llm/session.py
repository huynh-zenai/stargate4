...
class SessionAgent(Generic[T]):
    ...
    def __init__(
        ...
        *,
        ...
        # Per-session token accounting. Accumulated on every completion so the
        # pipeline can attribute cost/throughput to an individual candidate.
        self.usage: dict[str, Any] = {
            "calls": 0, "prompt_tokens": 0, "completion_tokens": 0,
            "total_tokens": 0, "finish_reasons": [],
        }
    ...
    async def _chat_with_tool_loop(self) -> str:
        ...
        for it in range(self.max_tool_iters + 1):
            ...
            self.usage["calls"] += 1
            self.usage["finish_reasons"].append(choice.finish_reason)
